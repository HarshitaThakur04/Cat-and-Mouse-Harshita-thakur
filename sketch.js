...
I2=loadAnimation("images/mouse2.png");
I3=loadAnimation("images/mouse3.png");
I4=loadAnimation("images/cat2.png");
...
function draw() {
    ...
    if(tom.x = jerry.x < (tom.width - jerry.width)/2){
        tom.velocityX = 0;
        tom.addAnimation("tomlastImage",16);
        tom.x = 300;
        tom.scale = 0.2;
